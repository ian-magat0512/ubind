// <copyright file="OrganisationAuthorisationServiceTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Authorisation
{
    ...
    public class OrganisationAuthorisationServiceTests
    {
        /// <summary>
        ...
        private IOrganisationAuthorisationService organisationAuthorisationService;
        ...
        public OrganisationAuthorisationServiceTests()
        {
            ...
            this.organisationAuthorisationService = this.GetOrganisationAuthorisationService();
        }

        [Fact]
        public async Task ThrowIfUserCannotViewOrganisation_Throws_WhenUserInDefaultOrgButDoesntHavePermission()
        {
            // Arrange
            ...
            // Act
            Func<Task> act = async () => await this.organisationAuthorisationService.ThrowIfUserCannotView(
        ...
        private OrganisationAuthorisationService GetOrganisationAuthorisationService()
        {
            var authorisationService = new OrganisationAuthorisationService(
                this.mediator.Object);
            return authorisationService;
        }
    }
