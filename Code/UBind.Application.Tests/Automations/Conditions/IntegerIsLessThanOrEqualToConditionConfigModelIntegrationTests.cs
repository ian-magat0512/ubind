// <copyright file="IntegerIsLessThanOrEqualToConditionConfigModelIntegrationTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Automations.Conditions
{
    ...
    public class IntegerIsLessThanOrEqualToConditionConfigModelIntegrationTests
        : ConditionConfigModelIntegrationTests
    {
        [Theory]
        [InlineData(0, 1, true)]
        [InlineData(-1, 0, true)]
