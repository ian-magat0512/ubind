// <copyright file="FakeRelease.cs" company="uBind">
...
namespace UBind.Application.Tests.Automations.Fakes
{
    ...
    /// Fake release class.
    /// </summary>
    internal class FakeRelease : Release
    {
        public FakeRelease(Guid tenantId, Guid productId, string fileName, string content, NodaTime.Instant createdTimestamp)
        : base(tenantId, productId, 1, 1, "label", ReleaseType.Major, createdTimestamp)
        {
            var e = string.Empty;
