// <copyright file="AndFilterProviderTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Automations.Filters
{
    ...
    public class AndFilterProviderTests
    {
        [Fact]
        public async Task Resolve_GivesPositiveResult_WhenAllFiltersGivePositiveResult()
        {
            // Arrange
        ...
        [Fact]
        public async Task Resolve_GivesNegativeResult_WhenSingleFiltersGiveNegativeResult()
        {
            // Arrange
            var filters = new List<IFilterProvider>
            {
