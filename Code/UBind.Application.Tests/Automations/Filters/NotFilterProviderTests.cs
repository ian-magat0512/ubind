// <copyright file="NotFilterProviderTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Automations.Filters
{
    ...
    public class NotFilterProviderTests
    {
        [Fact]
        public async Task Resolve_GivesPositiveResult_WhenFilterGivesNegativeResult()
        {
            // Arrange
            var inputFilter = new FakeFilterProvider<Data<int>>(_ => false);

            var sut = new NotFilterProvider(inputFilter);
        ...
        [Fact]
        public async Task Resolve_GivesNegativeResult_WhenFilterGivesPositiveResult()
        {
            // Arrange
            var inputFilter = new FakeFilterProvider<Data<int>>(_ => true);
