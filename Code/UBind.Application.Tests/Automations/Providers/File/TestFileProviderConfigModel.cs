// <copyright file="TestFileProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Tests.Automations.Providers.File
{
    ...
    public class TestFileProviderConfigModel : IBuilder<IProvider<Data<FileInfo>>>
    {
        public string FilePath { get; set; }

        public IProvider<Data<FileInfo>> Build(IServiceProvider dependencyProvider)
        {
            return new TestFileProvider(this.FilePath);
        }
    }
}
