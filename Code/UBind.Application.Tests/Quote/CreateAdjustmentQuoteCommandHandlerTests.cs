// <copyright file="CreateAdjustmentQuoteCommandHandlerTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Quote
{
    ...
    public class CreateAdjustmentQuoteCommandHandlerTests
    {
        ...
        public CreateAdjustmentQuoteCommandHandlerTests()
        {
        ...
        [Fact]
        public async Task CreateAdjustmentQuote_WithEnabledProductFeatureSetting_Succeeds()
        {
            // Arrange
            ...
            var command = new CreateAdjustmentQuoteCommand(
                TenantFactory.DefaultId,
                quoteAggregate.Policy.PolicyId,
                false);
            var handler = new CreateAdjustmentQuoteCommandHandler(
        ...
        /// </summary>
        [Fact]
        public async Task CreateAdjustmentQuote_WithDisabledProductFeatureSettings_ThrowsErrorExceptionAsync()
        {
            // Arrange
            var quoteAggregate = QuoteFactory.CreateNewPolicy();
            this.quoteAggregateRepositoryMock.Setup(s => s.GetById(It.IsAny<Guid>(), It.IsAny<Guid>())).Returns(quoteAggregate);
