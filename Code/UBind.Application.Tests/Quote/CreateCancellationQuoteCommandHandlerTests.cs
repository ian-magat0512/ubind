// <copyright file="CreateCancellationQuoteCommandHandlerTests.cs" company="uBind">
...
namespace UBind.Application.Tests.Quote
{
    ...
    public class CreateCancellationQuoteCommandHandlerTests
    {
        ...
        public CreateCancellationQuoteCommandHandlerTests()
        {
        ...
        [Fact]
        public async Task CreateCancellationQuote_WithEnabledProductFeatureSetting_Succeeds()
        {
            // Arrange
            ...
            var productFeatureSettings = new ProductFeatureSetting(
                ...
                ProductFactory.DefaultId,
                this.clock.Now());
            productFeatureSettings.Enable(Domain.Product.ProductFeatureSettingItem.CancellationQuotes);
            ...
            var command = new CreateCancellationQuoteCommand(
                TenantFactory.DefaultId,
                quoteAggregate.Policy.PolicyId,
                false);
            var handler = new CreateCancellationQuoteCommandHandler(
        ...
        /// </summary>
        [Fact]
        public async Task CreateCancellationQuote_WithDisabledProductFeatureSettings_ThrowsErrorExceptionAsync()
        {
            // Arrange
            var quoteAggregate = QuoteFactory.CreateNewPolicy();
            this.quoteAggregateRepositoryMock.Setup(s => s.GetById(It.IsAny<Guid>(), It.IsAny<Guid>())).Returns(quoteAggregate);
            var productFeatureSettings = new ProductFeatureSetting(
                ...
                ProductFactory.DefaultId,
                this.clock.Now());
            productFeatureSettings.Disable(Domain.Product.ProductFeatureSettingItem.CancellationQuotes);
            this.productFeatureSettingServiceMock
                .Setup(s => s.GetProductFeature(It.IsAny<Guid>(), It.IsAny<Guid>())).Returns(productFeatureSettings);
            var command = new CreateCancellationQuoteCommand(
                TenantFactory.DefaultId,
