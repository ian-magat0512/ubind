// <copyright file="AttachFilesToEntitiesActionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Actions
{
    ...
    /// </summary>
    public class AttachFilesToEntitiesActionConfigModel : BaseActionConfigurationModel, IBuilder<Action>
    {
        [JsonConstructor]
        public AttachFilesToEntitiesActionConfigModel(
            string name,
            string alias,
            string description,
            bool asynchronous,
            ...
            IEnumerable<IBuilder<BaseEntityProvider>> entities,
        ...
        /// <summary>
        /// Gets the collection of entities that the files should be attached to.
        /// </summary>
        public IEnumerable<IBuilder<BaseEntityProvider>> Entities { get; private set; } = Enumerable.Empty<IBuilder<BaseEntityProvider>>();
        ...
        public override Action Build(IServiceProvider dependencyProvider)
        {
            ...
            var entities = this.Entities?.Select(entity => entity.Build(dependencyProvider));
