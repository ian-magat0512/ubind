// <copyright file="DeclineQuoteActionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Actions
{
    ...
    public class DeclineQuoteActionConfigModel : BaseActionConfigurationModel, IBuilder<Action>
    {
        [JsonConstructor]
        public DeclineQuoteActionConfigModel(
            string name,
            string alias,
            string description,
            bool asynchronous,
