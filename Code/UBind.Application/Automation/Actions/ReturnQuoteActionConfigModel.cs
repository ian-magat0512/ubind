// <copyright file="ReturnQuoteActionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Actions
{
    ...
    public class ReturnQuoteActionConfigModel : BaseActionConfigurationModel, IBuilder<Action>
    {
        [JsonConstructor]
        public ReturnQuoteActionConfigModel(
            string name,
            string alias,
            string description,
            bool asynchronous,
