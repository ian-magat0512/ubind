// <copyright file="DateAfterOrEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateAfterOrEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalDate> Date { get; private set; }

        [JsonProperty]
        public DateToDateTimeProviderConfigModel IsAfterOrEqualTo { get; private set; }

        public IFilterProvider Build(IServiceProvider dependencyProvider)
        {
            return new DateAfterOrEqualToFilterProvider(
