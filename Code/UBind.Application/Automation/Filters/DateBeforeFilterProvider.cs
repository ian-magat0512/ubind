// <copyright file="DateBeforeFilterProvider.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateBeforeFilterProvider : DateFilterProviderBase, IFilterProvider
    {
        public DateBeforeFilterProvider(
            IExpressionProvider dateExpressionProvider,
            IProvider<Data<Instant>> isBeforeDateProvider)
            : base(dateExpressionProvider, isBeforeDateProvider, "dateIsBeforeCondition")
        {
        }
        ...
        {
            var isBeforeDateExpression = Expression.Constant(comparerValue.ToUtcAtStartOfDay().ToUnixTimeTicks());
            return Expression.LessThan(instantExpression, isBeforeDateExpression);
        }
