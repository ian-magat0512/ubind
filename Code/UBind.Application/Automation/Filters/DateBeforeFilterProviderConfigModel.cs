// <copyright file="DateBeforeFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateBeforeFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalDate> Date { get; private set; }

        [JsonProperty]
        public DateToDateTimeProviderConfigModel IsBefore { get; private set; }

        public IFilterProvider Build(IServiceProvider dependencyProvider)
        {
            return new DateBeforeFilterProvider(
