// <copyright file="DateEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalDate> Date { get; private set; }

        [JsonProperty]
        public DateToDateTimeProviderConfigModel IsEqualTo { get; private set; }

        IFilterProvider IBuilder<IFilterProvider>.Build(IServiceProvider dependencyProvider)
        {
            return new DateEqualToFilterProvider(
