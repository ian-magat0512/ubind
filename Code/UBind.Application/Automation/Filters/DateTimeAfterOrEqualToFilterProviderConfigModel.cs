// <copyright file="DateTimeAfterOrEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateTimeAfterOrEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> DateTime { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> IsAfterOrEqualTo { get; set; }
