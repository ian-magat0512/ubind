// <copyright file="DateTimeBeforeFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateTimeBeforeFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> DateTime { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> IsBefore { get; set; }
