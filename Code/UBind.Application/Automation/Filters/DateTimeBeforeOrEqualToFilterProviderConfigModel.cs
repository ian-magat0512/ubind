// <copyright file="DateTimeBeforeOrEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class DateTimeBeforeOrEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> DateTime { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<long> IsBeforeOrEqualTo { get; set; }
