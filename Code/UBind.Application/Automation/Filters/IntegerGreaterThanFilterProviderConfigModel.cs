// <copyright file="IntegerGreaterThanFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    /// <summary>
    /// Model for building an filter based on greater than comparison of integers.
    /// </summary>
    public class IntegerGreaterThanFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        /// <summary>
        /// Gets the model for building the provider for the first operand of the greater than filter.
        /// </summary>
        [JsonProperty]
        public IBuilder<IExpressionProvider> Integer { get; private set; }

        /// <summary>
        /// Gets the model for building the provider for the second operand of the greater than filter.
        /// </summary>
        [JsonProperty]
