// <copyright file="TextContainsFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    /// <summary>
    /// For providing a filters that test whether a text expressions contains text from a second expression.
    /// </summary>
    public class TextContainsFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the model for building the provider for the substring to test for.
        /// </summary>
        [JsonProperty]
        public IBuilder<IExpressionProvider> Contains { get; private set; }
