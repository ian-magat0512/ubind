// <copyright file="TimeAfterFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class TimeAfterFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> Time { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> IsAfter { get; set; }
