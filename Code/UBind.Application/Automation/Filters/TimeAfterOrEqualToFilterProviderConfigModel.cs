// <copyright file="TimeAfterOrEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class TimeAfterOrEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> Time { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> IsAfterOrEqualTo { get; set; }
