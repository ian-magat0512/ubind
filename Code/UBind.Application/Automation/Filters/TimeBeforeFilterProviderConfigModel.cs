// <copyright file="TimeBeforeFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class TimeBeforeFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> Time { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> IsBefore { get; set; }
