// <copyright file="TimeEqualToFilterProviderConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Filters
{
    ...
    public class TimeEqualToFilterProviderConfigModel : IBuilder<IFilterProvider>
    {
        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> Time { get; set; }

        [JsonProperty]
        public IDataExpressionProviderConfigModel<LocalTime> IsEqualTo { get; set; }
