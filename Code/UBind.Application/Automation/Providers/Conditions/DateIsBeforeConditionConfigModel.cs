// <copyright file="DateIsBeforeConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given date is before to a second given date.
    /// </summary>
    public class DateIsBeforeConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<LocalDate>>> IsBefore { get; set; }
