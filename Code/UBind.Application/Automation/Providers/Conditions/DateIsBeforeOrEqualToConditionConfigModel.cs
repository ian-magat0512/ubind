// <copyright file="DateIsBeforeOrEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given date is before or equal to a second given date.
    /// </summary>
    public class DateIsBeforeOrEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<LocalDate>>> IsBeforeOrEqualTo { get; set; }
