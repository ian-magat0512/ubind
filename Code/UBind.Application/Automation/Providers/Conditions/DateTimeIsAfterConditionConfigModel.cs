// <copyright file="DateTimeIsAfterConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given datetime is after to a second given datetime.
    /// </summary>
    public class DateTimeIsAfterConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<Instant>>> IsAfter { get; set; }
