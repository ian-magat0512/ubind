// <copyright file="DateTimeIsAfterOrEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given datetime is after or equal to a second given datetime.
    /// </summary>
    public class DateTimeIsAfterOrEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<Instant>>> IsAfterOrEqualTo { get; set; }
        ...
        public IProvider<Data<bool>> Build(IServiceProvider dependencyProvider)
        {
            return new ComparisonCondition<Instant>(
                ...
                this.IsAfterOrEqualTo.Build(dependencyProvider),
