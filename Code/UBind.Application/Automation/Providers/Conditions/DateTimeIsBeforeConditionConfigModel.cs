// <copyright file="DateTimeIsBeforeConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given datetime is before to a second given datetime.
    /// </summary>
    public class DateTimeIsBeforeConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<Instant>>> IsBefore { get; set; }
        ...
        public IProvider<Data<bool>> Build(IServiceProvider dependencyProvider)
        {
            return new ComparisonCondition<Instant>(
                ...
                this.IsBefore.Build(dependencyProvider),
