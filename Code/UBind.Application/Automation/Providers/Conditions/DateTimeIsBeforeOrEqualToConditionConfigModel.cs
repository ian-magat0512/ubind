// <copyright file="DateTimeIsBeforeOrEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given datetime is before or equal to a second given datetime.
    /// </summary>
    public class DateTimeIsBeforeOrEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<Instant>>> IsBeforeOrEqualTo { get; set; }
