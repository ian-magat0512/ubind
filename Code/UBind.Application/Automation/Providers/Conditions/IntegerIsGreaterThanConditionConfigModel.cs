// <copyright file="IntegerIsGreaterThanConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given integer is greater than a second given integer.
    /// </summary>
    public class IntegerIsGreaterThanConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<long>>> IsGreaterThan { get; set; }
