// <copyright file="IntegerIsGreaterThanOrEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given integer is greater than or equal to a second given integer.
    /// </summary>
    public class IntegerIsGreaterThanOrEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<long>>> IsGreaterThanOrEqualTo { get; set; }
