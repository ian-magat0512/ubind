// <copyright file="NumberIsGreaterThanConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given number is greater than to a second given number.
    /// </summary>
    public class NumberIsGreaterThanConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<decimal>>> IsGreaterThan { get; set; }
