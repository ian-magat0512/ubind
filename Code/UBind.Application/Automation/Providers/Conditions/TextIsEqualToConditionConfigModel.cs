// <copyright file="TextIsEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an instance of <see cref="TextIsEqualToCondition"/>.
    /// </summary>
    public class TextIsEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<string>>> IsEqualTo { get; set; }
        ...
        {
            return new TextIsEqualToCondition(
