// <copyright file="TimeIsAfterConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given time is after to a second given time.
    /// </summary>
    public class TimeIsAfterConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<LocalTime>>> IsAfter { get; set; }
