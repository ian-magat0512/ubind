// <copyright file="TimeIsBeforeConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given time is before to a second given time.
    /// </summary>
    public class TimeIsBeforeConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<LocalTime>>> IsBefore { get; set; }
