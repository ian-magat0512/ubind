// <copyright file="TimeIsEqualToConditionConfigModel.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Conditions
{
    ...
    /// <summary>
    /// Model for building an condition that tests if a given time is equal to a second given time.
    /// </summary>
    public class TimeIsEqualToConditionConfigModel : IBuilder<IProvider<Data<bool>>>
    {
        /// <summary>
        ...
        /// </summary>
        public IBuilder<IProvider<Data<LocalTime>>> IsEqualTo { get; set; }
