// <copyright file="PathLookupDateProvider.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Date
{
    ...
    /// path lookup date.
    /// </summary>
    /// <remarks>Schema key: objectPathLookupDate.</remarks>
    public class PathLookupDateProvider : IProvider<Data<LocalDate>>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PathLookupDateProvider"/> class.
        /// </summary>
        ...
        public string SchemaReferenceKey => "objectPathLookupDate";
        ...
        public async ITask<IProviderResult<Data<LocalDate>>> Resolve(IProviderContext providerContext)
        {
            ...
            if (lookupData == null)
            {
                ...
                if (lookupData == null)
                {
                    return ProviderResult<Data<LocalDate>>.Success(null);
                }
            }

            try
            {
                var date = lookupData.ToString().ToLocalDateFromIso8601OrDateTimeIso8601();
                return ProviderResult<Data<LocalDate>>.Success(date);
            }
            catch (Exception exception)
            {
                ...
                var date = valueIfTypeMismatch?.ToString().ToLocalDateFromIso8601OrDateTimeIso8601();
                return ProviderResult<Data<LocalDate>>.Success(date);
            }
        }
    }
