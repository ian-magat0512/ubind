// <copyright file="MoveOperation.cs" company="uBind">
...
namespace UBind.Application.Automation.Providers.Object.PatchObject
{
    ...
    /// <summary>
    /// This class is responsible for performing the move patch operation on the object.
    /// </summary>
    public class MoveOperation : BaseOperation
    {
        ...
        public override async Task<PatchObjectModel> Execute(JObject obj, IProviderContext providerContext)
        {
            ...
            this.from = (await this.FromProvider.Resolve(providerContext)).GetValueOrThrowIfFailed();
            this.to = (await this.ToProvider.Resolve(providerContext)).GetValueOrThrowIfFailed();
                ...
                this.WhenSourcePropertyNotFoundAction != PrePatchDirective.None)
            {
                ...
                var error = Errors.Automation.Provider.PatchObject.PathNotFound("move", this.message, details);
                ...
                this.WhenDestinationParentPropertyNotFoundAction != PrePatchDirective.None)
            {
                ...
                var details = this.GetErrorData(obj);
                var error = Errors.Automation.Provider.PatchObject.PathNotFound("move", "Destination parent property not found", details);
                ...
                this.WhenDestinationPropertyAlreadyExistsAction != PrePatchDirective.None)
            {
                ...
                patchDocument.Remove(this.from);

                this.message = "Destination property already exists";
                var details = this.GetErrorData(obj);
                var error = Errors.Automation.Provider.PatchObject.PathAlreadyExists("move", "Destination property already exists", details);
            ...
            if (targetIsRoot || valueIsObject)
            {
                if (fromObject is IDictionary valueDictionary)
                {
                    ...
                    if (targetIsRoot || pathExistsForGivenPath)
                    {
                    ...
                    {
                        patchDocument.Move(this.from, this.to);
                    }
                }
                ...
                else
                {
                    ...
                    throw new ErrorException(Errors.Automation.Provider.PatchObject.CannotMovePrimitiveToObject(
