// <copyright file="CreateRefundCommand.cs" company="uBind">
...
namespace UBind.Domain.Commands.Accounting
{
    ...
    /// </summary>
    public class CreateRefundCommand : CreateFinancialTransactionCommand, ICommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRefundCommand"/> class.
        /// </summary>
        /// <param name="tenantId">The tenant Id associated with this refund.</param>
