// <copyright file="DisableAuthenticationMethodCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.AuthenticationMethod
{
    ...
    public class DisableAuthenticationMethodCommandHandler
        : ICommandHandler<DisableAuthenticationMethodCommand, AuthenticationMethodReadModelSummary>
    {
        ...
        public DisableAuthenticationMethodCommandHandler(
        ...
        public async Task<AuthenticationMethodReadModelSummary> Handle(DisableAuthenticationMethodCommand command, CancellationToken cancellationToken)
        {
            ...
            await this.authenticationMethodService.Disable(organisationAggregate, command.AuthenticationMethodId);
