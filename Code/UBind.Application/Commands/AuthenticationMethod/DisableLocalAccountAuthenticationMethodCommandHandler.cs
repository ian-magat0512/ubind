// <copyright file="DisableLocalAccountAuthenticationMethodCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.AuthenticationMethod
{
    ...
    public class DisableLocalAccountAuthenticationMethodCommandHandler
        : ICommandHandler<DisableLocalAccountAuthenticationMethodCommand, AuthenticationMethodReadModelSummary>
    {
        ...
        public DisableLocalAccountAuthenticationMethodCommandHandler(
        ...
        public async Task<AuthenticationMethodReadModelSummary> Handle(
            DisableLocalAccountAuthenticationMethodCommand command, CancellationToken cancellationToken)
        {
            ...
            {
                // enable it
                await this.authenticationMethodService.Disable(organisationAggregate, record.Id);
            }
