// <copyright file="UpdateDkimSettingsCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.DkimSettings
{
    ...
    /// <summary>
    /// Command for updating DKIM settings.
    /// </summary>
    public class UpdateDkimSettingsCommand : ICommand<DkimSettings>
    {
        public UpdateDkimSettingsCommand(
            Guid tenantId,
            Guid dkimSettingsId,
            Guid organisationId,
            string domainName,
