// <copyright file="SetManagingOrganisationCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.Organisation
{
    ...
    public class SetManagingOrganisationCommand : ICommand
    {
        public SetManagingOrganisationCommand(
            Guid tenantId,
            Guid organisationId,
