// <copyright file="EnablePortalCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.Portal
{
    ...
    public class EnablePortalCommandHandler : ICommandHandler<EnablePortalCommand, PortalReadModel>
    {
        ...
        public EnablePortalCommandHandler(
        ...
        public async Task<PortalReadModel> Handle(EnablePortalCommand command, CancellationToken cancellationToken)
        {
            ...
            portalAggregate.Enable(performingUserId, now);
