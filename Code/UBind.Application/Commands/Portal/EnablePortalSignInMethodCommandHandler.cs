// <copyright file="EnablePortalSignInMethodCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.Portal
{
    ...
    public class EnablePortalSignInMethodCommandHandler : ICommandHandler<EnablePortalSignInMethodCommand, Unit>
    {
        ...
        public EnablePortalSignInMethodCommandHandler(
        ...
        public async Task<Unit> Handle(EnablePortalSignInMethodCommand command, CancellationToken cancellationToken)
        {
            ...
            portalAggregate.EnableSignInMethod(command.AuthenticationMethodId, performingUserId, now);
