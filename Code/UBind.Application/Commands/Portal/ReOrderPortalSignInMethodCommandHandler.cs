// <copyright file="ReOrderPortalSignInMethodCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.Portal
{
    ...
    public class ReOrderPortalSignInMethodCommandHandler : ICommandHandler<ReOrderPortalSignInMethodCommand, Unit>
    {
        ...
        public ReOrderPortalSignInMethodCommandHandler(
        ...
        public async Task<Unit> Handle(ReOrderPortalSignInMethodCommand command, CancellationToken cancellationToken)
        {
            ...
            portalAggregate.UpdateSignInMethodSortOrder(command.AuthenticationMethodId, command.SortOrder, performingUserId, now);
