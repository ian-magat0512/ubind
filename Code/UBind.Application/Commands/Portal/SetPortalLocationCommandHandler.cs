// <copyright file="SetPortalLocationCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.Portal
{
    ...
    public class SetPortalLocationCommandHandler : ICommandHandler<SetPortalLocationCommand, PortalReadModel>
    {
        ...
        public SetPortalLocationCommandHandler(
        ...
        public async Task<PortalReadModel> Handle(SetPortalLocationCommand command, CancellationToken cancellationToken)
        {
