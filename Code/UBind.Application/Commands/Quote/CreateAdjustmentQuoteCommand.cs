// <copyright file="CreateAdjustmentQuoteCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.Quote
{
    ...
    public class CreateAdjustmentQuoteCommand : ICommand<NewQuoteReadModel>
    {
        public CreateAdjustmentQuoteCommand(
            Guid tenantId,
            Guid policyId,
