// <copyright file="CreateCancellationQuoteCommandHandler.cs" company="uBind">
...
public class CreateCancellationQuoteCommandHandler
    : ICommandHandler<CreateCancellationQuoteCommand, NewQuoteReadModel>
{
    ...
    public CreateCancellationQuoteCommandHandler(
    ...
    public async Task<NewQuoteReadModel> Handle(CreateCancellationQuoteCommand command, CancellationToken cancellationToken)
    {
        ...
        using (await this.aggregateLockingService.CreateLockOrThrow(command.TenantId, quoteAggregateId, AggregateType.Quote))
        {
            ...
            {
                throw new ErrorException(Errors.General.NotAuthorized("create a cancellation quote", entityName, command.PolicyId));
            }
            ...
            if (!productFeature.AreCancellationQuotesEnabled)
            {
                throw new ErrorException(Errors.ProductFeatureSetting.QuoteTypeDisabled(quoteAggregate.ProductId, product.Details.Name, "Cancellation"));
            }
            ...
            var cancellationQuote = policy.CreateCancellationQuote(
                this.clock.Now(),
                quoteNumber,
            ...
            return cancellationQuote.ReadModel;
        }
    }
}
