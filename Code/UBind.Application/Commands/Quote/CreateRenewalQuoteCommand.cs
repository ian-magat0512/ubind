// <copyright file="CreateRenewalQuoteCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.Quote
{
    ...
    public class CreateRenewalQuoteCommand : ICommand<NewQuoteReadModel>
    {
        public CreateRenewalQuoteCommand(
            Guid tenantId,
            Guid policyId,
