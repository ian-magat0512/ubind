// <copyright file="ReferQuoteForReviewCommandHandler.cs" company="uBind">
...
public class ReferQuoteForReviewCommandHandler : ICommandHandler<ReferQuoteForReviewCommand, NewQuoteReadModel>
{
    ...
    public ReferQuoteForReviewCommandHandler(
    ...
    public async Task<NewQuoteReadModel> Handle(ReferQuoteForReviewCommand command, CancellationToken cancellationToken)
    {
        ...
        using (await this.aggregateLockingService.CreateLockOrThrow(command.TenantId, quoteAggregateId, AggregateType.Quote))
        {
            ...
            await this.quoteEndorsementService.ReferQuoteForReview(releaseContext, quote, command.FormData);
