// <copyright file="ReturnQuoteCommandHandler.cs" company="uBind">
...
public class ReturnQuoteCommandHandler : ICommandHandler<ReturnQuoteCommand, NewQuoteReadModel>
{
    ...
    public ReturnQuoteCommandHandler(
    ...
    public async Task<NewQuoteReadModel> Handle(ReturnQuoteCommand command, CancellationToken cancellationToken)
    {
        ...
        using (await this.aggregateLockingService.CreateLockOrThrow(command.TenantId, quoteAggregateId, AggregateType.Quote))
        {
            ...
            await this.quoteEndorsementService.ReturnQuote(releaseContext, quote, command.FormData);
