// <copyright file="DeleteTenantCommandHandler.cs" company="uBind">
...
namespace UBind.Application.Commands.Tenant
{
    ...
    public class DeleteTenantCommandHandler : ICommandHandler<DeleteTenantCommand, Unit>
    {
        ...
        public Task<Unit> Handle(DeleteTenantCommand command, CancellationToken cancellationToken)
        {
