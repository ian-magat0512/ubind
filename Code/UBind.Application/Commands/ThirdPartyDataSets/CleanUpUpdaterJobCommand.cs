// <copyright file="CleanUpUpdaterJobCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.ThirdPartyDataSets
{
    ...
    /// </summary>
    public class CleanUpUpdaterJobCommand : ICommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleanUpUpdaterJobCommand"/> class.
        /// </summary>
        /// <param name="updaterJobManifest">The updater job manifest.</param>
        /// <param name="jobId">The updater job id.</param>
        public CleanUpUpdaterJobCommand(IUpdaterJobManifest updaterJobManifest, Guid jobId)
        {
