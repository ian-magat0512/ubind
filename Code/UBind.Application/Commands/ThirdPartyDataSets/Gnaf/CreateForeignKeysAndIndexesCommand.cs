// <copyright file="CreateForeignKeysAndIndexesCommand.cs" company="uBind">
...
namespace UBind.Application.Commands.ThirdPartyDataSets.Gnaf
{
    ...
    /// </summary>
    public class CreateForeignKeysAndIndexesCommand : ICommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateForeignKeysAndIndexesCommand"/> class.
        /// </summary>
        /// <param name="updaterJobManifest">The updater job manifest.</param>
        /// <param name="jobId">The updater job id.</param>
        public CreateForeignKeysAndIndexesCommand(IUpdaterJobManifest updaterJobManifest, Guid jobId)
        {
