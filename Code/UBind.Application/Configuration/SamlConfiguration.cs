// <copyright file="SamlConfiguration.cs" company="uBind">
...
namespace UBind.Application.Configuration
{
    ...
    {
        public string? ServiceProviderCertificateSubjectName { get; set; }
        ...
        public string? ServiceProviderCertificateBase64 { get; set; }

        public void Dispose()
        {
            if (this.ServiceProviderCertificate != null)
            {
                this.ServiceProviderCertificate.Dispose();
            }
        }
    }
}
