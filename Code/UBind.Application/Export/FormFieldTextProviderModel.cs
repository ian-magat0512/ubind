// <copyright file="FormFieldTextProviderModel.cs" company="uBind">
...
namespace UBind.Application.Export
{
    ...
    /// </summary>
    public class FormFieldTextProviderModel : IExporterModel<ITextProvider>
    {
        /// <summary>
        ...
        /// <param name="productConfiguration">Contains per.</param>
        ...
        {
            return new FormFieldTextProvider(this.FieldName?.Build(dependencyProvider, productConfiguration));
        }
    }
}
