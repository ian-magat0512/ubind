// <copyright file="IIntegrationConfigurationParser.cs" company="uBind">
...
namespace UBind.Application.Export
{
    ...
    /// </summary>
    public interface IIntegrationConfigurationParser
    {
        /// <summary>
        ...
        IntegrationConfigurationModel Parse(string exportConfigJson);
    }
}
