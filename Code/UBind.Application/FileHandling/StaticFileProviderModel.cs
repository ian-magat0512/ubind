// <copyright file="StaticFileProviderModel.cs" company="uBind">
...
namespace UBind.Application.FileHandling
{
    ...
    /// <summary>
    /// Model for static file provider.
    /// </summary>
    public class StaticFileProviderModel : IExporterModel<IAttachmentProvider>
    {
        /// <summary>
