// <copyright file="CalculationTriggerTemplateJObjectProvider.cs" company="uBind">
...
namespace UBind.Application.FileHandling.Template_Provider
{
    ...
    /// <summary>
    /// Calculation trigger template JSON object provider.
    /// </summary>
    public class CalculationTriggerTemplateJObjectProvider : IJObjectProvider
    {
        /// <inheritdoc/>
        ...
        public Task CreateJsonObject(ApplicationEvent applicationEvent)
        {
            ...
            try
            {
                ...
                IJsonObjectParser parser = new GenericJObjectParser(
                    string.Empty, calculationDataObj.SelectToken("triggers"));
