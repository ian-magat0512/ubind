// <copyright file="PremiumFundingError.cs" company="uBind">
...
namespace UBind.Application.Funding.PremiumFunding
{
    ...
    /// </summary>
    public class PremiumFundingError
    {
        /// <summary>
        ...
        public IEnumerable<PremiumFundingErrorDetail> Details { get; private set; }
    }
}
