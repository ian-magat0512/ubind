// <copyright file="AllRefundsByPayerQuery.cs" company="uBind">
...
namespace UBind.Application.Queries.Accounting
{
    ...
    /// </summary>
    public class AllRefundsByPayerQuery : IQuery<IEnumerable<RefundReadModel>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllRefundsByPayerQuery"/> class.
        /// </summary>
        /// /// <param name="payerId">The payer id.</param>
        /// <param name="payerType">The payer type.</param>
        public AllRefundsByPayerQuery(Guid payerId, TransactionPartyType payerType)
        {
