...
namespace UBind.Application.Queries.Claim.Version
{
    ...
    public class GetClaimVersionByIdQueryHandler : IQueryHandler<GetClaimVersionByIdQuery, ClaimVersionReadModel>
    {
        ...
        public GetClaimVersionByIdQueryHandler(
        ...
        public Task<ClaimVersionReadModel> Handle(GetClaimVersionByIdQuery query, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            var claimVersion = this.claimVersionReadModelRepository.GetById(
