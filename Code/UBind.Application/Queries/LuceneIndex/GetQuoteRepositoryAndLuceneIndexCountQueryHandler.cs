// <copyright file="GetQuoteRepositoryAndLuceneIndexCountQueryHandler.cs" company="uBind">
...
namespace UBind.Application.Queries.LuceneIndex
{
    ...
    public class GetQuoteRepositoryAndLuceneIndexCountQueryHandler : IQueryHandler<GetQuoteRepositoryAndLuceneIndexCountQuery, IEnumerable<IEntityRepositoryAndLuceneIndexCountModel>>
    {
        ...
        public GetQuoteRepositoryAndLuceneIndexCountQueryHandler(
        ...
        /// <inheritdoc/>
        public Task<IEnumerable<IEntityRepositoryAndLuceneIndexCountModel>> Handle(GetQuoteRepositoryAndLuceneIndexCountQuery query, CancellationToken cancellationToken)
        {
