// <copyright file="GetAvailableNumbersFromPoolQuery.cs" company="uBind">
...
/// </summary>
public class GetAvailableNumbersFromPoolQuery : IQuery<NumberPoolSummaryModel>
{
    public GetAvailableNumbersFromPoolQuery(
