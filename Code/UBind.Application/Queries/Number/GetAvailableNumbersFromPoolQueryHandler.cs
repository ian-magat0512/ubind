// <copyright file="GetAvailableNumbersFromPoolQueryHandler.cs" company="uBind">
...
public class GetAvailableNumbersFromPoolQueryHandler : IQueryHandler<GetAvailableNumbersFromPoolQuery, NumberPoolSummaryModel>
{
    private readonly INumberPoolService numberPoolService;
    private readonly ICachingResolver cacheResolver;
    private readonly IAuthorisationService authorisationService;

    public GetAvailableNumbersFromPoolQueryHandler(
    ...
    public async Task<NumberPoolSummaryModel> Handle(GetAvailableNumbersFromPoolQuery request, CancellationToken cancellationToken)
    {
        ...
        var numbers = this.numberPoolService.GetAvailable(
