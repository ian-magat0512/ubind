// <copyright file="GetTenantByIdQueryHandler.cs" company="uBind">
...
namespace UBind.Application.Queries.Tenant
{
    ...
    public class GetTenantByIdQueryHandler : IQueryHandler<GetTenantByIdQuery, Domain.Tenant>
    {
        ...
        public Task<Tenant> Handle(GetTenantByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            Domain.Tenant tenant
                = this.tenantRepository.GetTenantById(request.TenantId);
