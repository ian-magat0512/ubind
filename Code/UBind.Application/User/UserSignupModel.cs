// <copyright file="UserSignupModel.cs" company="uBind">
...
namespace UBind.Application.User
{
    ...
    /// User sign-up model.
    /// </summary>
    public class UserSignupModel : IPersonalDetails
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the deployment environment so we know where to send the user to activate.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to send an activation invitation.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the initial roles of the new user.
        /// </summary>
        public IEnumerable<Guid> InitialRoles { get; set; }
