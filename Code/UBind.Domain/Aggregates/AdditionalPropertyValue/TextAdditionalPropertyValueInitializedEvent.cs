// <copyright file="TextAdditionalPropertyValueInitializedEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.AdditionalPropertyValue
{
    ...
    /// <summary>
    /// Extended class for text additional property value.
    /// </summary>
    public partial class TextAdditionalPropertyValue
    {
        /// <summary>
        /// Event raised when creating a new text additional property value.
        /// </summary>
        public class TextAdditionalPropertyValueInitializedEvent :
            Event<TextAdditionalPropertyValue, Guid>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="TextAdditionalPropertyValueInitializedEvent"/> class.
            /// </summary>
            ...
            public TextAdditionalPropertyValueInitializedEvent(
                Guid tenantId,
                Guid id,
