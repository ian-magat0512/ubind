// <copyright file="ClaimDataUpdate.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Claim
{
    ...
    public class ClaimDataUpdate<TData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimDataUpdate{TData}"/> class.
        /// </summary>
        ...
        public ClaimDataUpdate(Guid id, TData data, Instant createdTimestamp)
        {
            this.Id = id;
            this.Data = data;
