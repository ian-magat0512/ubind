...
namespace UBind.Domain.Aggregates.Claim
{
    ...
    public partial class ClaimAggregate
    {
        ...
        /// </summary>
        public class CustomerAssignedEvent : Event<ClaimAggregate, Guid>
        {
            /// <summary>
            ...
            public CustomerAssignedEvent(
                Guid tenantId, Guid claimId, Guid customerId, Guid personId, IPersonalDetails customerDetails, Guid? performingUserId, Instant createdTimestamp)
