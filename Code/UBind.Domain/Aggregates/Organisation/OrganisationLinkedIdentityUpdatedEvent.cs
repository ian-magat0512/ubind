// <copyright file="OrganisationLinkedIdentityUpdatedEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Organisation
{
    ...
    public partial class Organisation
    {
        ...
        /// </summary>
        public class OrganisationLinkedIdentityUpdatedEvent : Event<Organisation, Guid>
        {
            public OrganisationLinkedIdentityUpdatedEvent(
                Guid tenantId,
                Guid organisationId,
            ...
            [JsonConstructor]
            private OrganisationLinkedIdentityUpdatedEvent()
                : base()
            {
            }
