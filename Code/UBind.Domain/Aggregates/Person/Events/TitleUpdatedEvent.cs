// <copyright file="TitleUpdatedEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Person
{
    ...
    public partial class PersonAggregate
    {
        ...
        /// </summary>
        public class TitleUpdatedEvent : PropertyUpdateEvent<string, PersonAggregate, Guid>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="TitleUpdatedEvent"/> class.
            /// </summary>
            ...
            public TitleUpdatedEvent(Guid tenantId, Guid personId, string company, Guid? performingUserId, Instant createdTimestamp)
            : base(tenantId, personId, company, performingUserId, createdTimestamp)
            {
            }

            [JsonConstructor]
            private TitleUpdatedEvent()
            {
            }
        }
    }
