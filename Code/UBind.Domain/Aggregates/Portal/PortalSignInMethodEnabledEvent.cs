// <copyright file="PortalSignInMethodEnabledEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Portal
{
    ...
    {
        public class PortalSignInMethodEnabledEvent : Event<PortalAggregate, Guid>
        {
            public PortalSignInMethodEnabledEvent(
                Guid tenantId,
                Guid portalId,
