// <copyright file="UseSavedPaymentMethodFieldRetriever.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Quote.DataLocator.StandardQuoteDataRetriever
{
    ...
    public class UseSavedPaymentMethodFieldRetriever : BaseFieldRetriever
    {
        public override object Retrieve(IDataLocatorConfig config, CachingJObjectWrapper formData, CachingJObjectWrapper calculationData)
        {
            ...
            var dataLocations = this.GetDataLocations(config.DataLocators?.UseSavedPaymentMethod, config.QuoteDataLocations?.UseSavedPaymentMethod);
