// <copyright file="CancellationPolicyTransaction.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Quote.Entities
{
    ...
    public class CancellationPolicyTransaction : PolicyTransaction
    {
        [System.Text.Json.Serialization.JsonConstructor]
        public CancellationPolicyTransaction(
            Guid id,
            Guid? quoteId,
        ...
        public CancellationPolicyTransaction(Guid transactionId, QuoteAggregate.PolicyCancelledEvent @event, int eventSequenceNumber)
            : base(
                  transactionId,
                  @event,
                  eventSequenceNumber)
