...
namespace UBind.Domain.Aggregates.Quote
{
    ...
    {
        public class OwnershipUnassignedEvent : Event<QuoteAggregate, Guid>
        {
            public OwnershipUnassignedEvent(Guid tenantId, Guid quoteId, Guid? performingUserId, Instant createdTimestamp)
