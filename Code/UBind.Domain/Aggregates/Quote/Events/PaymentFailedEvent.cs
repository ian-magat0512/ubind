// <copyright file="PaymentFailedEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Quote
{
    ...
    public partial class QuoteAggregate
    {
        ...
        /// </summary>
        public class PaymentFailedEvent : QuoteSnapshotFailureEvent<PaymentFailedEvent>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="PaymentFailedEvent"/> class.
            /// </summary>
            /// <param name="tenantId">The tenant Id.</param>
            /// <param name="aggregateId">The ID of the quote aggregate.</param>
            /// <param name="quote">The ID of the quote.</param>
