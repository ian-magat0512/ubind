// <copyright file="PolicyEmailGeneratedEvent.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Quote
{
    ...
    public partial class QuoteAggregate
    {
        ...
        /// </summary>
        public class PolicyEmailGeneratedEvent
            : Event<QuoteAggregate, Guid>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="PolicyEmailGeneratedEvent"/> class.
            /// </summary>
            /// <param name="tenantId">The tenant Id.</param>
            /// <param name="aggregateId">The aggregate Id.</param>
            /// <param name="policyTransactionId">The ID of the quote aggregate.</param>
            ...
            /// <param name="performingUserId">The userId who generated policy email.</param>
            public PolicyEmailGeneratedEvent(
                Guid tenantId,
                Guid aggregateId,
            ...
            [JsonConstructor]
            private PolicyEmailGeneratedEvent()
            {
                // Nothing to do
            }
