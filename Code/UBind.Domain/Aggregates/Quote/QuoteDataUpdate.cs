// <copyright file="QuoteDataUpdate.cs" company="uBind">
...
namespace UBind.Domain
{
    ...
    public class QuoteDataUpdate<TData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteDataUpdate{TData}"/> class.
        /// </summary>
        ...
        public QuoteDataUpdate(Guid id, TData data, Instant createdTimestamp)
        {
            this.Id = id;
            this.Data = data;
