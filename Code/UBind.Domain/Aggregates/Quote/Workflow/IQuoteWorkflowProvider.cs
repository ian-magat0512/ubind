// <copyright file="IQuoteWorkflowProvider.cs" company="uBind">
...
namespace UBind.Domain.Aggregates.Quote.Workflow
{
    ...
    /// </summary>
    public interface IQuoteWorkflowProvider
    {
        /// <summary>
        ...
        Task<IQuoteWorkflow> GetConfigurableQuoteWorkflow(ReleaseContext releaseContext);
    }
}
