// <copyright file="IDefaultRolePermissionsRegistry.cs" company="uBind">
...
namespace UBind.Domain.Permissions
{
    ...
    /// </summary>
    public interface IDefaultRolePermissionsRegistry
    {
        /// <summary>
        ...
        IReadOnlyList<Permission> GetPermissionsForDefaultRole(DefaultRole defaultRole);
    }
}
