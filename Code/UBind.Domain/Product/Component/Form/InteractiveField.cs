// <copyright file="InteractiveField.cs" company="uBind">
...
{
    /// <summary>
    /// Represents configuration for a field which can be interacted with by the user.
    /// </summary>
    public abstract class InteractiveField : VisibleField, IDataStoringField
    {
        /// <summary>
        /// Gets or sets a value indicating whether this field is required to be filled out by a user.
        /// </summary>
        [WorkbookTableColumnName("Required")]
        public bool? Required { get; set; }

        /// <summary>
        /// Gets or sets a string which is used as placeholder text, which is shown
        /// in the field until the user starts typing or selecting something.
        /// </summary>
        ...
        /// Disabled fields do not receive focus and their values are not submitted with the form.
        /// </summary>
        [WorkbookTableColumnName("Disabled Condition")]
        public string DisabledConditionExpression { get; set; }

        /// <summary>
        /// Gets or sets a UBind Expression which if evaluates to true, the field becomes read only.
        /// Read only fields can still receive focus, and their values are still submitted with the form.
        /// </summary>
        [WorkbookTableColumnName("Read Only Condition")]
        public string ReadOnlyConditionExpression { get; set; }
        ...
        /// <summary>
        /// Gets or sets an auto-tab expression that is evaluated when the field is focused.
        /// </summary>
        public string? AutoTabExpression { get; set; }
    }
}
