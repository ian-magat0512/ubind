// <copyright file="PasswordField.cs" company="uBind">
...
namespace UBind.Domain.Product.Component.Form
{
    ...
    /// </summary>
    [WorkbookFieldType("Password")]
    [JsonFieldType("password")]
    public class PasswordField : InteractiveField, ILineInputField, IKeyboardInputField
    {
        /// <summary>
