// <copyright file="TextAreaField.cs" company="uBind">
...
namespace UBind.Domain.Product.Component.Form
{
    ...
    /// </summary>
    [WorkbookFieldType("Text Area")]
    [JsonFieldType("text-area")]
    public class TextAreaField : InteractiveField, IKeyboardInputField
    {
        /// <summary>
