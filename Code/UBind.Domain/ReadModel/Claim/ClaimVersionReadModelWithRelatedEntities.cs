// <copyright file="ClaimVersionReadModelWithRelatedEntities.cs" company="uBind">
...
namespace UBind.Domain.ReadModel.Claim
{
    ...
    /// <summary>
    /// This class is needed because we need a data transfer object for claim version and its related entities.
    /// </summary>
    public class ClaimVersionReadModelWithRelatedEntities : IClaimVersionReadModelWithRelatedEntities
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public ClaimVersionReadModel ClaimVersion { get; set; }
