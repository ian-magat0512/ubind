// <copyright file="IClaimVersionReadModelWithRelatedEntities.cs" company="uBind">
...
namespace UBind.Domain.ReadModel.Claim
{
    ...
    /// <summary>
    /// Interface for claim version and its related entities.
    /// </summary>
    public interface IClaimVersionReadModelWithRelatedEntities : IEntityReadModelWithRelatedEntities, IEntitySupportingAdditionalProperties
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the policy transactions related to the policy of this claim.
        /// </summary>
        /// <remarks>This property is only populated if policy is included.</remarks>
        ...
        /// <summary>
        /// Gets or sets the claim version  associated with a claim.
        /// </summary>
        ClaimVersionReadModel ClaimVersion { get; set; }
        ...
        /// <summary>
        /// Gets or sets the list sms associated with the claim version.
        /// </summary>
        IEnumerable<Sms> Sms { get; set; }

        /// <summary>
        /// Gets or sets the source relationships associated with the claim version.
        /// </summary>
        IEnumerable<Relationship> FromRelationships { get; set; }

        /// <summary>
        /// Gets or sets the target relationships associated with the claim version.
        /// </summary>
