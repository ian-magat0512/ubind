// <copyright file="IQuoteVersionReadModelWithRelatedEntities.cs" company="uBind">
...
namespace UBind.Domain.ReadModel
{
    ...
    /// <summary>
    /// Interface for quote version and its related entities.
    /// </summary>
    public interface IQuoteVersionReadModelWithRelatedEntities : IEntityReadModelWithRelatedEntities, IEntitySupportingAdditionalProperties
    {
        /// <summary>
        /// Gets or sets the quote version.
        /// </summary>
        QuoteVersionReadModel QuoteVersion { get; set; }
        ...
        /// <summary>
        /// Gets or sets the list of sms associated with the quote version.
        /// </summary>
        IEnumerable<ReadWriteModel.Sms> Sms { get; set; }

        /// <summary>
        /// Gets or sets the source relationships associated with the quote version.
        /// </summary>
        IEnumerable<Relationship> FromRelationships { get; set; }

        /// <summary>
        /// Gets or sets the target relationships associated with the quote version.
        /// </summary>
