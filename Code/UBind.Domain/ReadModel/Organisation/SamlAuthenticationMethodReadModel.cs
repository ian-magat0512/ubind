// <copyright file="SamlAuthenticationMethodReadModel.cs" company="uBind">
...
namespace UBind.Domain.ReadModel.Organisation
{
    ...
    public class SamlAuthenticationMethodReadModel : AuthenticationMethodReadModelSummary
    {
        public SamlAuthenticationMethodReadModel(
        ...
        /// </summary>
        public string? IdentityProviderArtifactResolutionServiceUrl { get; set; }
        ...
        /// <summary>
        /// Gets or sets a default role which all users provisioned by this authentication method will be given.
        /// </summary>
        ...
        /// </summary>
        public string? RoleMapJson { get; set; }

        [NotMapped]
        public Dictionary<string, Guid>? RoleMap
        {
            get
            {
                if (string.IsNullOrWhiteSpace(this.RoleMapJson))
                {
                    return new Dictionary<string, Guid>();
                }

                return JsonSerializer.Deserialize<Dictionary<string, Guid>>(this.RoleMapJson);
            }

            set
            {
                this.RoleMapJson = value != null ? JsonSerializer.Serialize(value) : null;
            }
        }
        ...
        {
            base.Update(@event);
            Saml source = (Saml)@event.AuthenticationMethod;
            this.IdentityProviderEntityIdentifier = source.IdentityProviderEntityIdentifier;
            this.IdentityProviderSingleSignOnServiceUrl = source.IdentityProviderSingleSignOnServiceUrl;
            this.IdentityProviderSingleLogoutServiceUrl = source.IdentityProviderSingleLogoutServiceUrl;
            this.IdentityProviderArtifactResolutionServiceUrl = source.IdentityProviderArtifactResolutionServiceUrl;
            if (source.IdentityProviderCertificate != null)
            {
                var rawData = source.IdentityProviderCertificate.Export(X509ContentType.Cert);
                var base64String = Convert.ToBase64String(rawData);
                this.IdentityProviderCertificate = base64String;
            }

            this.MustSignAuthenticationRequests = source.MustSignAuthenticationRequests;
            this.ShouldLinkExistingCustomerWithSameEmailAddress = source.ShouldLinkExistingCustomerWithSameEmailAddress;
            this.CanCustomerAccountsBeAutoProvisioned = source.CanCustomerAccountsBeAutoProvisioned;
            this.CanCustomerDetailsBeAutoUpdated = source.CanCustomerDetailsBeAutoUpdated;
            this.ShouldLinkExistingAgentWithSameEmailAddress = source.ShouldLinkExistingAgentWithSameEmailAddress;
            this.CanAgentAccountsBeAutoProvisioned = source.CanAgentAccountsBeAutoProvisioned;
            this.CanAgentDetailsBeAutoUpdated = source.CanAgentDetailsBeAutoUpdated;
            this.CanUsersOfManagedOrganisationsSignIn = source.CanUsersOfManagedOrganisationsSignIn;
            this.CanOrganisationsBeAutoProvisioned = source.CanOrganisationsBeAutoProvisioned;
            this.ShouldLinkExistingOrganisationWithSameAlias = source.ShouldLinkExistingOrganisationWithSameAlias;
            this.CanOrganisationDetailsBeAutoUpdated = source.CanOrganisationDetailsBeAutoUpdated;
            this.NameIdFormat = source.NameIdFormat;
            this.UseNameIdAsUniqueIdentifier = source.UseNameIdAsUniqueIdentifier;
            this.UseNameIdAsEmailAddress = source.UseNameIdAsEmailAddress;
            this.UniqueIdentifierAttributeName = source.UniqueIdentifierAttributeName;
            this.FirstNameAttributeName = source.FirstNameAttributeName;
            this.LastNameAttributeName = source.LastNameAttributeName;
            this.EmailAddressAttributeName = source.EmailAddressAttributeName;
            this.PhoneNumberAttributeName = source.PhoneNumberAttributeName;
            this.MobileNumberAttributeName = source.MobileNumberAttributeName;
            this.UserTypeAttributeName = source.UserTypeAttributeName;
            this.OrganisationUniqueIdentifierAttributeName = source.OrganisationUniqueIdentifierAttributeName;
            this.OrganisationNameAttributeName = source.OrganisationNameAttributeName;
            this.OrganisationAliasAttributeName = source.OrganisationAliasAttributeName;
            this.RoleAttributeName = source.RoleAttributeName;
            this.RoleAttributeValueDelimiter = source.RoleAttributeValueDelimiter;
            this.DefaultAgentRoleId = source.DefaultAgentRoleId;
            this.RoleMap = source.RoleMap;
            this.AreRolesManagedExclusivelyByThisIdentityProvider = source.AreRolesManagedExclusivelyByThisIdentityProvider;
        }
    }
}
