// <copyright file="PriceBreakdownResponseModel.cs" company="uBind">
...
namespace UBind.Domain.ReadWriteModel
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceBreakdownResponseModel"/> class.
        /// </summary>
        /// <param name="priceBreakdown">The price Breakdown object.</param>
        public PriceBreakdownResponseModel(PriceBreakdown priceBreakdown)
        {
