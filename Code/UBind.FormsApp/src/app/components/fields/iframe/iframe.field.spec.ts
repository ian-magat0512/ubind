...
import formConfig from './iframe.test-form-config.json';
...
describe('IframeField', () => {
    ...
    beforeEach(async () => {
        return TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: IqumulatePremiumFundingApiService, useValue: {} },
    ...
    it('when an iFrame field\'s urlExpression changes, the iframe renders the new URL', async () => {
        // Arrange
        ...
        response2.form.questionSets[0].fields[0].urlExpression = "/test2.html";
        ...
        return new Promise((resolve: any, reject: any): void => {
            eventService.webFormLoadedSubject
                ...
                .subscribe(async () => {
                    fixture.detectChanges();
                    let field1: HTMLInputElement = fixture.debugElement.query(By.css('#test1Iframe')).nativeElement;
                    expect(field1.getAttribute('src').startsWith('/test1.html'))
                        .toBeTruthy('The src should start with "/test1.html"');
                    ...
                    // Assert
                    field1 = fixture.debugElement.query(By.css('#test1Iframe')).nativeElement;
                    expect(field1.getAttribute('src').startsWith('/test2.html'))
                        .toBeTruthy('The src should start with "/test2.html"');
                    resolve();
                });
        });
    });
