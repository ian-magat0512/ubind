...
import formConfig from './footer-widget.test-form-config.json';
...
describe('FooterWidget', () => {
    ...
    @Component({
        ...
        template: `<web-form></web-form>
                  <ubind-footer-widget class="page-footer"></ubind-footer-widget>`,
    })
    ...
    it('renders the correct content when the workflow step changes', async () => {
        // Arrange
        ...
        return new Promise((resolve: any, reject: any): void => {
            eventService.webFormLoadedSubject
                ...
                .subscribe(async () => {
                    ...
                    expect(step1Element.innerText).toContain('My content 1 Step 1');
