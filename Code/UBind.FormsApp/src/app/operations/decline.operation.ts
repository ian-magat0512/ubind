...
/**
 * Declines a quote so that it cannot be bound.
 */
@Injectable()
export class DeclineOperation extends OperationWithPayload {
    public static opName: string = 'decline';
    public operationName: string = DeclineOperation.opName;
