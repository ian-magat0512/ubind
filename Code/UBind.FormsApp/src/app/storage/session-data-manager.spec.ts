...
describe('Session', () => {
    ...
    it('should get tenantAlias in figi in local storage.', () => {
        const tenantAlias: string = 'figi';
        const organisationAlias: string = 'figiiii';

        const session: SessionDataManager = new SessionDataManager();
        const value: string | Array<string> = session.getTenantOrganisationSessionValue(
    ...
    it('should get userType (ClientAdmin) in local storage.', () => {
        const tenantAlias: string = 'figi';
        const organisationAlias: string = 'figiiii';
    ...
    it('should get accessToken in local storage return not be null.', () => {
        const tenantAlias: string = 'figi';
        const organisationAlias: string = 'figiiii';
    ...
    it('should get tenant and organisation key prefix in local storage should be found return true.', () => {
        const tenantAlias: string = 'figi';
        const organisationAlias: string = 'figiiii';

        const session: SessionDataManager = new SessionDataManager();
        const value: boolean = session.tenantAndOrganisationSessionExists(
            tenantAlias,
            organisationAlias);
