...
export const searchAnimation: AnimationTriggerMetadata = trigger('searchAnimation', [
    state('*', style({ opacity: 1 })),
    state('void', style({ opacity: 0 })),
    transition('void => *', [
        animate('200ms ease-in-out'),
...
export const loaderAnimation: AnimationTriggerMetadata = trigger('loaderAnimation', [
    state('*', style({ opacity: 1 })),
    state('void', style({ opacity: 0 })),
    transition('void => *', [
