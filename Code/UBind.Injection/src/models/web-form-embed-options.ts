export interface WebFormEmbedOptions {
    ...
    /**
     * The organisation of the portal that the user is logged into.
     */
    ...
    /**
     * A url which the page will be redirected to upon successful completion of the workflow.
     * The redirect is triggered when the web form is closed, and it's application state is complete.
     */
    succeededRedirectUrl: string;

    /**
     * A url which the page will be redirected to should the flow not be completed but closed.
     * The redirect is triggered when the web form is closed, and it's application state is not complete.
     */
    abortedRedirectUrl: string;

    /**
     * A function which is called upon successful completion of the workflow.
     * The callback is invoked when the web form is closed, and it's application state is complete.
     * The data passed in is the product configured data to be returned.
     */
    succeededCallback: (data: any) => void;

    /**
     * A function which is called when the flow is closed without completion.
     * The callback is invoked when the web form is closed, and it's application state is not complete.
     * The data passed in is the product configured data to be returned.
     */
    abortedCallback: (data: any) => void;
}
