...
/**
 * A model for a form input control to capture a phone number.
 */
export class DetailsListFormPhoneItem extends DetailsListFormItem {
    ...
    public static create(
        ...
        alias: string,
        description: string,
    ): DetailsListFormPhoneItem {
        return new DetailsListFormPhoneItem(
            card,
            'default',
            alias,
            null,
