...
/**
 * A model for a form intput control for taking in multiple lines of text.
 */
export class DetailsListFormTextAreaItem extends DetailsListFormItem {
    ...
    public static create(
        ...
        alias: string,
        description: string,
    ): DetailsListFormTextAreaItem {
        return new DetailsListFormTextAreaItem(
            card,
            'default',
            alias,
            null,
