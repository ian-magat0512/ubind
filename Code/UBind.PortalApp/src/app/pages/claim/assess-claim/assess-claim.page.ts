...
import { FormsAppClaimPage } from '@app/pages/forms-app/forms-app-claim.page';
...
/**
 * Export assess claim page component class
 * TODO: Write a better class header: assessment of cliams.
 */
@Component({
...
export class AssessClaimPage extends FormsAppClaimPage implements OnInit, SplitLayoutManager {
    public constructor(
    ...
    public ngOnInit(): void {
        ...
        this.title = this.action = 'Assess Claim';
        this.loadClaimFormsApp(WebFormHelper.modes.Assess);
    }
}
