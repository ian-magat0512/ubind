...
/**
 * Export review claim page component class
 * This class manage of reviewing of claim.
 */
@Component({
...
export class ReviewClaimPage extends FormsAppClaimPage implements OnInit, SplitLayoutManager {
    ...
    public ngOnInit(): void {
        ...
        this.title = this.action = 'Review Claim';
        this.loadClaimFormsApp(WebFormHelper.modes.Review);
    }
}
