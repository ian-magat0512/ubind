...
/**
 * Export settle claim page component class
 * TODO: Write a better class header: settlement of claims.
 */
@Component({
    selector: 'app-settle-claim',
...
export class SettleClaimPage extends FormsAppClaimPage implements OnInit, SplitLayoutManager {
    ...
    public ngOnInit(): void {
        ...
        this.title = this.action = 'Settle Claim';
        this.loadClaimFormsApp(WebFormHelper.modes.Settle);
    }
}
