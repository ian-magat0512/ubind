...
import { ExternalRedirectGuard } from "@app/providers/guard/external-redirect.guard";
 ...
 */
export const pageRoutes: TypedRoutes = [
    {
    ...
    },
    {
        ...
        data: {
            sequentialGuards: [PortalRedirectGuard, PathRedirectGuard, EnvironmentGuard, AuthenticationGuard],
    ...
    },
    {
        ...
        canActivate: [ExternalRedirectGuard,AuthenticationGuard],
        data: {
    ...
    },
    {
        ...
        data: {
            sequentialGuards: [
                PortalRedirectGuard, PathRedirectGuard, EnvironmentGuard, AuthenticationGuard, PermissionGuard],
    ...
    },
    {
        ...
        data: {
            sequentialGuards: [
                PortalRedirectGuard, PathRedirectGuard, AuthenticationGuard, PermissionGuard],
            mustHavePermissions: [Permission.ViewMessages, Permission.ViewAllMessages],
        },
    },
    {
