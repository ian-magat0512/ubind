// <copyright file="SignupModelValidationUnitTest.cs" company="uBind">
...
namespace UBind.Web.Tests.ModelValidation
{
    ...
    /// <summary>
    /// Defines the <see cref="SignupModelValidationUnitTest" />.
    /// </summary>
    public class SignupModelValidationUnitTest
    {
        [InlineData(
            "jeo",
        ...
        [InlineData(
            ...
            "+61 0 0000 0000")]
        [Theory]
        public void SignupModel_Validation_Success_IfValidInput(
        ...
        [InlineData(
            ...
            "+41 0 0000 0000")]
        [Theory]
        public void SignupModel_Validation_Fail_IfInvalidInput(
             string preferredName,
             string fullName,
             string namePrefix,
             string firstName,
