// <copyright file="UserUpdateModelValidationUnitTest.cs" company="uBind">
...
namespace UBind.Web.Tests.ModelValidation
{
    ...
    /// <summary>
    /// Defines the <see cref="UserUpdateModelValidationUnitTest" />.
    /// </summary>
    public class UserUpdateModelValidationUnitTest
    {
        [InlineData(
                    "jeo",
        ...
        [InlineData(
                    ...
                    "+61 0 0000 0000")]
        [Theory]
        public void UserUpdateModel_Validation_Success_IfValidInput(
        ...
        [InlineData(
            ...
            "+41 0 0000 0000")]
        [Theory]
        public void UserUpdateModel_Validation_Fail_IfInvalidInput(
             string preferredName,
             string fullName,
             string namePrefix,
             string firstName,
