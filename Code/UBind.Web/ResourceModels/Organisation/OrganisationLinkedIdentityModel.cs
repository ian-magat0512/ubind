// <copyright file="OrganisationLinkedIdentityModel.cs" company="uBind">
...
namespace UBind.Web.ResourceModels.Organisation
{
    ...
    /// <summary>
    /// Represents the organisation's link to an external identity provider.
    /// </summary>
    public class OrganisationLinkedIdentityModel
    {
        /// <summary>
        /// Resource model which represents the organisation's link to an external identity provider.
        /// </summary>
        public OrganisationLinkedIdentityModel(OrganisationLinkedIdentityReadModel readModel)
        {
