// <copyright file="QuotePeriodicSummaryQueryOptionsModel.cs" company="uBind">
...
namespace UBind.Web.ResourceModels
{
    ...
    /// </summary>
    public class QuotePeriodicSummaryQueryOptionsModel : BasePeriodicSummaryQueryOptionsModel, IPeriodicSummaryQueryOptionsModel
    {
        /// <summary>
        /// Gets or sets the policy transaction types included in the result set.
        /// </summary>
        [FromQuery(Name = "policyTransactionType")]
        public IEnumerable<string>? PolicyTransactionTypes { get; set; }

        protected override HashSet<string> ValidIncludeProperties => QuotePeriodicSummaryModel.IncludeProperties;
        ...
        public async Task<QuoteReadModelFilters> ToFilters(Guid contextTenantId, ICachingResolver cachingResolver)
        {
            ...
            filter.DateFilteringPropertyName = nameof(NewQuoteReadModel.CreatedTicksSinceEpoch);
        ...
        {
            return new QuoteSummaryGeneratorFactory().GetNumberOfExpectedPeriods(
