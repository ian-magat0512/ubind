// <copyright file="IdOrAliasAttribute.cs" company="uBind">
...
namespace UBind.Web.Validation
{
    ...
    public class IdOrAliasAttribute : ValidationAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdOrAliasAttribute"/> class.
        /// </summary>
        public IdOrAliasAttribute()
        {
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            var isGuid = Guid.TryParse(value.ToString(), out Guid id);
            if (isGuid)
            {
                return true;
            }
