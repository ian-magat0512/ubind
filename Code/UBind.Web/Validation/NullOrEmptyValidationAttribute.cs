// <copyright file="NullOrEmptyValidationAttribute.cs" company="uBind">
...
namespace UBind.Web.Validation
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullOrEmptyValidationAttribute"/> class.
        /// </summary>
        public NullOrEmptyValidationAttribute()
        {
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            {
                this.ErrorMessage = "{0} must be have content.";
            }
